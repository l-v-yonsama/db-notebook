...
import { registerToolActivityTreeCommand } from "../../src/toolActivity/ToolActivityTreeCommand";
import type { ToolActivityCategoryElement } from "../../src/toolActivity/ToolActivityTreeProvider";
import type { ToolInvocationRecord } from "../../src/toolActivity/ToolInvocationTracker";
...
vi.mock("../../src/toolActivity/ToolInvocationTracker", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../src/toolActivity/ToolInvocationTracker")>();
