...
} from "../../src/toolActivity/ToolActivityTreeProvider";
import type * as ProviderModule from "../../src/toolActivity/ToolActivityTreeProvider";
...
vi.mock("../../src/mcpServer/singleton", () => ({
  detectRunningServer: detectRunningServerMock,
}));
vi.mock("../../src/mcpServer/server", () => ({
...
beforeEach(async () => {
  ...
  providerModule = await import("../../src/toolActivity/ToolActivityTreeProvider");
  vi.useFakeTimers();
});
